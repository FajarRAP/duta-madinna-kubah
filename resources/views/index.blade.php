...
<body>
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Desa Sukorejo - Kec.
                        Gandusari Kab. Trenggalek, Jawa Timur</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>0812 9833 9091</small>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-2 px-sm-5 py-3 py-lg-0">
            <a href="index.html" class="navbar-brand p-0 d-flex align-items-center gap-3">
