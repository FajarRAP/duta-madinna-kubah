<x-app-layout>
    ...
    <header class="bg-white shadow">
        <div class="container mx-auto flex justify-between items-center p-4">
            <h1 class="text-2xl font-bold text-red-600">Duta Madinna Kubah</h1>
            <nav class="space-x-6">
    ...
    <section class="bg-red-600 text-white py-20">
        <div class="container mx-auto text-center px-6">
            ...
            <a href="#contact" class="bg-white text-red-600 px-6 py-3 rounded-full font-semibold hover:bg-gray-100">
                Hubungi Kami
            </a>
        </div>
    </section>
    ...
    <section id="contact" class="py-20 bg-gray-100">
        <div class="container mx-auto px-6 max-w-xl">
            ...
            <a href="https://wa.me/6285316979307"
                class="w-full bg-red-600 text-white p-3 rounded font-semibold hover:bg-red-700 block text-center">
                Kirim Pesan
            </a>
        </div>
    </section>
